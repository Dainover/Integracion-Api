    ...
    <>
          <footer className="bg-white dark:bg-gray-800">
            ...
            <div className="text-center">
                ...
                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2021-2022 Landwind™. All Rights Reserved. Built with <Link to="https://flowbite.com" className="text-purple-600 hover:underline dark:text-purple-500">Flowbite</Link> and <Link to="https://tailwindcss.com" className="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</Link>.
                </span>
                <ul className="flex justify-center mt-5 space-x-5">
                    <li>
                        <Link to="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400">
